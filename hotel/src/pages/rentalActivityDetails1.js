...
function RentalActivityDetails11() {
                ...
                <Container fluid>
                    <Row className="mb-4">
                        <div className="activity_details d-flex align-items-center">
                            ...
                            <div>
                                <h4 className="title">Royal Enfield Himalayan 650</h4>
                            ...
                            <div className="ms-auto" >
                                <div class="venderdetailsdoller1 text-white">
                                    <p>Booked Amount</p>
                                    <h2 className="text-center">$2070.00</h2>
...
export default RentalActivityDetails11;