...
import { Breadcrumb, Container, Row, Col, Form, Button, Nav, Tab, TabPane, Modal } from "react-bootstrap";
...
class editProfile extends Component {
    ...
    editProfileAPI = async () => {
        ...
        await http.postData(`v1/hotel/update/profile`, formdata)
            .then(result => {
                console.log("===================", result);
    ...
    handleChangeOtp = () => {
        ...
        if (this.state.otp == '') {
            this.setState({
                message_err: "Please Enter the OTP"
            })
        } else {
           var urlencoded = new URLSearchParams();
           urlencoded.append("mobile_no", this.state.form.mobile.phone);
        ...
        return (
            ...
            <Backdrop
                ...
                }
                {
                    Danger ? <SweetAlert
                        warning
                        title="We sent otp on your mobile number"
                        customButtons={
                            <React.Fragment>
                ...
                <Modal show={this.state.otpVerify}  onHide={this.setShow} >
                            ...
                            <Form>
                                <Row>
                                    ...
                                    <div className="editform">
                                        ...
                                        <Form.Control type="text" placeholder="Enter Code" id="otp" name="otp" maxLength={4} value={this.state.otp} onChange={this.handleChangeverify} />
                                    </div>
                                    </Col>
                                    <Row>
                                    <Col lg={12} md={4} sm={12} >
                                        <div class="addbutt2 mt-4 text-center">
                                            <Button type="button" className="custom_btn" onClick={this.handleChangeOtp}>Submit</Button>
                                        </div>
                                    </Col>
                                    </Row>
                                </Row>
