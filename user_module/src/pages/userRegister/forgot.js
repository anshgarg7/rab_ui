...
class Forgot extends Component {
    ...
    handleOtp = () => {
        ...
        http.Login_APi(`v1/user/forgot_password`, urlencoded)
            .then(result => {
            ...
            .catch(error => {
                ...
                // console.log("uiewyurweuiweuyruiyweuiyruiweyerui",error);
                                        ...
                                        <center>
                                            ...
                                            {loading ? 
                                                <Spinner animation="border" role="status" className="spinner_custom" style={{color: '#fff'}}>
                                                    {/* <span className="sr-only custom"  style={{fontSize: '5px'}} > Loading  </span> */}
                                                </Spinner> 
