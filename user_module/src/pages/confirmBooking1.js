...
class ConfirmBooking1 extends Component {
                    ...
                    <Row >
                            ...
                            <div className="searchlistcar d-sm-inline-flex">
                                ...
                                <div className="searchlistdata">
                                    ...
                                    <div class="addbutt1 mt-4">
                                        <Link to="/taxibooking" className="custom_btn">Cancel Booking</Link>
                                    </div>
                                    <p className="mt-3">
                        ...
                        <Col className="p-0" md={5}>
                            <div className="mapimg">
                                <div className="mt-2">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15282225.79979123!2d73.7250245393691!3d20.750301298393563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30635ff06b92b791%3A0xd78c4fa1854213a6!2sIndia!5e0!3m2!1sen!2sin!4v1587818542745!5m2!1sen!2sin" width="100%" height="570" frameborder="0" style={{ border: 0 }} allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                </div>
                            </div>
                        </Col>
